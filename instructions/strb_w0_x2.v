...
(*  ReadReg "__v84_implemented" [] (Val_Bool false) Mk_annot;*)
  ...
  Smt (DefineConst 93%Z (Binop (Eq) (Val (Val_Symbolic 28%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  ...
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 93%Z) Mk_annot) Mk_annot)) Mk_annot;
(*  ReadReg "__highest_el_aarch32" [] (Val_Bool false) Mk_annot;*)
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 93%Z) Mk_annot) Mk_annot)) Mk_annot;
  ReadReg "SCTLR_EL2" [] (Val_Bits [BV{64%N} 0x4000002%Z]) Mk_annot;
  Smt (DefineConst 98%Z (Binop (Eq) (Val (Val_Symbolic 89%Z) Mk_annot) (Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 89%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0xffffffffffffffff%Z]) Mk_annot] Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Unop (Not) (Val (Val_Symbolic 98%Z) Mk_annot) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Unop (Not) (Val (Val_Symbolic 98%Z) Mk_annot) Mk_annot) Mk_annot)) Mk_annot;
...
(*  ReadReg "__v83_implemented" [] (Val_Bool false) Mk_annot;*)
  ...
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 943%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (DefineConst 982%Z (Binop (Eq) (Val (Val_Symbolic 28%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 982%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 982%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Unop (Not) (Val (Val_Symbolic 98%Z) Mk_annot) Mk_annot) Mk_annot)) Mk_annot;
  ...
  Smt (DeclareConst 1248%Z (Ty_BitVec 64%N)) Mk_annot;
  ReadReg "MPIDR_EL1" [] (Val_Symbolic 1248%Z) Mk_annot;
  Smt (DefineConst 1279%Z (Binop (Eq) (Val (Val_Symbolic 28%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 1279%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 1279%Z) Mk_annot) Mk_annot)) Mk_annot;
...
(*  ReadReg "__CNTControlBase" [] (Val_Bits [BV{52%N} 0x0%Z]) Mk_annot;*)
  Smt (DeclareConst 1322%Z (Ty_BitVec 56%N)) Mk_annot;
(*  ReadReg "__defaultRAM" [] (Val_Symbolic 1322%Z) Mk_annot;*)
(*  ReadReg "__isla_monomorphize_writes" [] (Val_Bool false) Mk_annot;*)
  Smt (DefineConst 1335%Z (Unop (ZeroExtend 8%N) (Manyop Concat [Val (Val_Bits [BV{4%N} 0x0%Z]) Mk_annot; Unop (Extract 51%N 0%N) (Val (Val_Symbolic 89%Z) Mk_annot) Mk_annot] Mk_annot) Mk_annot)) Mk_annot;
  Smt (DeclareConst 1336%Z Ty_Bool) Mk_annot;
  WriteMem (Val_Symbolic 1336%Z) (Val_Enum ((Mk_enum_id 6%nat), Mk_enum_ctor 0%nat)) (Val_Symbolic 1335%Z) (Val_Symbolic 91%Z) 1%N None Mk_annot
].
