...
Definition a90004 : isla_trace :=
  ...
  WriteReg "SPSR_EL2" [] (RegVal_Base (Val_Symbolic 282%Z)) Mk_annot :t:
  ...
  Smt (DefineConst 335%Z (Manyop Concat [Unop (Extract 63%N 11%N) (Val (Val_Symbolic 29%Z) Mk_annot) Mk_annot; Val (Val_Bits (BV 11%N 0x400%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
  Smt (DefineConst 347%Z (Val (Val_Symbolic 335%Z) Mk_annot)) Mk_annot :t:
  BranchAddress (RegVal_Base (Val_Symbolic 347%Z)) Mk_annot :t:
  Smt (DefineConst 348%Z (Val (Val_Symbolic 335%Z) Mk_annot)) Mk_annot :t:
  WriteReg "_PC" [] (RegVal_Base (Val_Symbolic 348%Z)) Mk_annot :t:
  tnil
.
