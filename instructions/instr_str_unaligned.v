...
Definition instr_str_unaligned : isla_trace :=
  ...
  Smt (DeclareConst 119%Z (Ty_BitVec 64%N)) Mk_annot :t:
  ReadReg "R0" [] (RegVal_Base (Val_Symbolic 119%Z)) Mk_annot :t:
  Smt (DeclareConst 134%Z Ty_Bool) Mk_annot :t:
  Smt (DeclareConst 243%Z (Ty_BitVec 64%N)) Mk_annot :t:
  ReadReg "_PC" [] (RegVal_Base (Val_Symbolic 243%Z)) Mk_annot :t:
  Smt (DefineConst 244%Z (Val (Val_Symbolic 243%Z) Mk_annot)) Mk_annot :t:
  tcases [
    Smt (Assert (Val (Val_Symbolic 134%Z) Mk_annot)) Mk_annot :t:
    Smt (DefineConst 492%Z (Val (Val_Symbolic 118%Z) Mk_annot)) Mk_annot :t:
    ...
    WriteReg "SPSR_EL2" [] (RegVal_Base (Val_Symbolic 519%Z)) Mk_annot :t:
    WriteReg "ELR_EL2" [] (RegVal_Base (Val_Symbolic 244%Z)) Mk_annot :t:
    ...
    tnil;
    Smt (Assert (Unop (Not) (Val (Val_Symbolic 134%Z) Mk_annot) Mk_annot)) Mk_annot :t:
    Smt (DefineConst 492%Z (Val (Val_Symbolic 118%Z) Mk_annot)) Mk_annot :t:
    ReadReg "PSTATE" [Field "N"] (RegVal_Struct [("N", RegVal_Base (Val_Symbolic 17%Z))]) Mk_annot :t:
    ReadReg "PSTATE" [Field "Z"] (RegVal_Struct [("Z", RegVal_Base (Val_Symbolic 27%Z))]) Mk_annot :t:
    ReadReg "PSTATE" [Field "C"] (RegVal_Struct [("C", RegVal_Base (Val_Symbolic 5%Z))]) Mk_annot :t:
