...
Definition instr_ldr : isla_trace :=
  ...
  Smt (DefineConst 69%Z (Binop (Eq) (Val (Val_Symbolic 65%Z) Mk_annot) (Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 65%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xfffffffffffffff8%Z)) Mk_annot] Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (DeclareConst 1394%Z (Ty_BitVec 64%N)) Mk_annot :t:
  ReadMem (RegVal_Base (Val_Symbolic 1394%Z)) (RegVal_Poison) (RegVal_Base (Val_Symbolic 1393%Z)) 8%N None Mk_annot :t:
  Smt (DefineConst 1398%Z (Val (Val_Symbolic 1394%Z) Mk_annot)) Mk_annot :t:
  WriteReg "R0" [] (RegVal_Base (Val_Symbolic 1398%Z)) Mk_annot :t:
