...
(*  ReadReg "__defaultRAM" [] (Val_Symbolic 1277%Z) Mk_annot;*)
(*  ReadReg "__isla_monomorphize_reads" [] (Val_Bool false) Mk_annot;*)
  ...
  ReadMem (Val_Symbolic 1287%Z) (Val_Enum ((Mk_enum_id 6%nat), Mk_enum_ctor 0%nat)) (Val_Symbolic 1286%Z) 1%N None Mk_annot;
  ...
  WriteReg "R0" [] (Val_Symbolic 1291%Z) Mk_annot;
  Smt (DefineConst 1292%Z (Val (Val_Symbolic 87%Z) Mk_annot)) Mk_annot;
  WriteReg "R1" [] (Val_Symbolic 1292%Z) Mk_annot
].
