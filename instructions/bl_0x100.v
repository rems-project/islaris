...
(*  ReadReg "__v85_implemented" [] (Val_Bool false) Mk_annot;*)
  ...
  WriteReg "R30" [] (Val_Symbolic 49%Z) Mk_annot;
  Smt (DefineConst 50%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 47%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x100%Z]) Mk_annot] Mk_annot)) Mk_annot;
