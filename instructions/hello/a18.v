...
Definition a18 : isla_trace :=
  ...
  Smt (DefineConst 63%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 26%Z) Mk_annot; Val (Val_Bits (BV 64%N 0x1%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
  Smt (DefineConst 67%Z (Binop (Eq) (Val (Val_Symbolic 63%Z) Mk_annot) (Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 63%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xffffffffffffffff%Z)) Mk_annot] Mk_annot) Mk_annot)) Mk_annot :t:
  ReadReg "PSTATE" [Field "D"] (RegVal_Struct [("D", RegVal_Base (Val_Symbolic 3%Z))]) Mk_annot :t:
  Smt (DefineConst 1242%Z (Val (Val_Symbolic 63%Z) Mk_annot)) Mk_annot :t:
  Smt (DefineConst 1390%Z (Manyop Concat [Val (Val_Bits (BV 4%N 0x0%Z)) Mk_annot; Unop (Extract 51%N 0%N) (Val (Val_Symbolic 63%Z) Mk_annot) Mk_annot] Mk_annot)) Mk_annot :t:
  Smt (DefineConst 1391%Z (Unop (ZeroExtend 8%N) (Val (Val_Symbolic 1390%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (DeclareConst 1392%Z (Ty_BitVec 8%N)) Mk_annot :t:
  ReadMem (RegVal_Base (Val_Symbolic 1392%Z)) (RegVal_Poison) (RegVal_Base (Val_Symbolic 1391%Z)) 1%N None Mk_annot :t:
  Smt (DefineConst 1396%Z (Manyop Concat [Val (Val_Bits (BV 32%N 0x0%Z)) Mk_annot; Manyop Concat [Val (Val_Bits (BV 24%N 0x0%Z)) Mk_annot; Val (Val_Symbolic 1392%Z) Mk_annot] Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "R0" [] (RegVal_Base (Val_Symbolic 1396%Z)) Mk_annot :t:
  Smt (DefineConst 1397%Z (Val (Val_Symbolic 63%Z) Mk_annot)) Mk_annot :t:
  WriteReg "R1" [] (RegVal_Base (Val_Symbolic 1397%Z)) Mk_annot :t:
  Smt (DeclareConst 1398%Z (Ty_BitVec 64%N)) Mk_annot :t:
  ReadReg "_PC" [] (RegVal_Base (Val_Symbolic 1398%Z)) Mk_annot :t:
  Smt (DefineConst 1399%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 1398%Z) Mk_annot; Val (Val_Bits (BV 64%N 0x4%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "_PC" [] (RegVal_Base (Val_Symbolic 1399%Z)) Mk_annot :t:
  tnil
.
