...
Definition a8 : isla_trace :=
  ...
  Smt (DefineConst 50%Z (Manyop (Bvmanyarith Bvadd) [Unop (Extract 63%N 0%N) (Unop (ZeroExtend 64%N) (Val (Val_Symbolic 28%Z) Mk_annot) Mk_annot) Mk_annot; Val (Val_Bits (BV 64%N 0x690%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "R1" [] (RegVal_Base (Val_Symbolic 50%Z)) Mk_annot :t:
