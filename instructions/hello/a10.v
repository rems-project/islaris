...
Definition a10 : isla_trace :=
  ...
  ReadReg "R2" [] (RegVal_Base (Val_Symbolic 44%Z)) Mk_annot :t:
  Smt (DefineConst 47%Z (Manyop (Bvmanyarith Bvor) [Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 44%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xffffffff0000ffff%Z)) Mk_annot] Mk_annot; Val (Val_Bits (BV 64%N 0x101f0000%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "R2" [] (RegVal_Base (Val_Symbolic 47%Z)) Mk_annot :t:
