...
Definition a10 : isla_trace :=
  ...
  Smt (DefineConst 35%Z (Manyop (Bvmanyarith Bvor) [Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 32%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xffffffff0000ffff%Z)) Mk_annot] Mk_annot; Val (Val_Bits (BV 64%N 0x101f0000%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
