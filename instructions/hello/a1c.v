...
Definition a1c : isla_trace :=
  ...
  Smt (DefineConst 29%Z (Binop (Eq) (Binop (Eq) (Unop (Extract 31%N 0%N) (Val (Val_Symbolic 26%Z) Mk_annot) Mk_annot) (Val (Val_Bits (BV 32%N 0x0%Z)) Mk_annot) Mk_annot) (Val (Val_Bool false) Mk_annot) Mk_annot)) Mk_annot :t:
  tcases [
    ...
    Smt (DefineConst 31%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 30%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xfffffffffffffff8%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
    Smt (DefineConst 32%Z (Val (Val_Symbolic 31%Z) Mk_annot)) Mk_annot :t:
    BranchAddress (RegVal_Base (Val_Symbolic 32%Z)) Mk_annot :t:
    Smt (DefineConst 33%Z (Val (Val_Symbolic 31%Z) Mk_annot)) Mk_annot :t:
