...
Definition a14 : list trc := [
  [
    ...
    ReadReg "MPIDR_EL1" [] (RegVal_Base (Val_Symbolic 1219%Z)) Mk_annot;
    ...
    WriteMem (RegVal_Base (Val_Symbolic 1302%Z)) (RegVal_Base (Val_Enum ((Mk_enum_id 6%nat), Mk_enum_ctor 0%nat))) (RegVal_Base (Val_Symbolic 1301%Z)) (RegVal_Base (Val_Symbolic 91%Z)) 1%N None Mk_annot
  ]
].
