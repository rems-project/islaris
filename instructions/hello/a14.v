...
Definition a14 : list trc := [
  [
    ...
    Assume (AExp_Binop (Eq) (AExp_Manyop (Bvmanyarith Bvand) [AExp_Val (AVal_Var "R2" []) Mk_annot; AExp_Val (AVal_Bits [BV{64%N} 0xfff0000000000000%Z]) Mk_annot] Mk_annot) (AExp_Val (AVal_Bits [BV{64%N} 0x0%Z]) Mk_annot) Mk_annot) Mk_annot;
    Smt (Assert (Binop (Eq) (Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 29%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0xfff0000000000000%Z]) Mk_annot] Mk_annot) (Val (Val_Bits [BV{64%N} 0x0%Z]) Mk_annot) Mk_annot)) Mk_annot;
    ...
    ReadReg "R0" [] (RegVal_Base (Val_Symbolic 90%Z)) Mk_annot;
    ...
    Smt (DeclareConst 1258%Z (Ty_BitVec 64%N)) Mk_annot;
    ReadReg "MPIDR_EL1" [] (RegVal_Base (Val_Symbolic 1258%Z)) Mk_annot;
    Smt (DeclareConst 1327%Z (Ty_BitVec 56%N)) Mk_annot;
    Smt (DefineConst 1340%Z (Unop (ZeroExtend 8%N) (Manyop Concat [Val (Val_Bits [BV{4%N} 0x0%Z]) Mk_annot; Unop (Extract 51%N 0%N) (Val (Val_Symbolic 89%Z) Mk_annot) Mk_annot] Mk_annot) Mk_annot)) Mk_annot;
    Smt (DeclareConst 1341%Z Ty_Bool) Mk_annot;
    WriteMem (RegVal_Base (Val_Symbolic 1341%Z)) (RegVal_Base (Val_Enum ((Mk_enum_id 6%nat), Mk_enum_ctor 0%nat))) (RegVal_Base (Val_Symbolic 1340%Z)) (RegVal_Base (Val_Symbolic 91%Z)) 1%N None Mk_annot;
    Smt (DeclareConst 1342%Z (Ty_BitVec 64%N)) Mk_annot;
    ReadReg "_PC" [] (RegVal_Base (Val_Symbolic 1342%Z)) Mk_annot;
    Smt (DefineConst 1343%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 1342%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x4%Z]) Mk_annot] Mk_annot)) Mk_annot;
    WriteReg "_PC" [] (RegVal_Base (Val_Symbolic 1343%Z)) Mk_annot
  ]
].
