...
Definition a80194 : isla_trace :=
  ...
  Smt (DefineConst 92%Z (Unop (Extract 31%N 0%N) (Val (Val_Symbolic 91%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (DefineConst 97%Z (Binop (Eq) (Val (Val_Symbolic 90%Z) Mk_annot) (Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 90%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0xfffffffffffffffc%Z]) Mk_annot] Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  WriteMem (RegVal_Base (Val_Symbolic 1342%Z)) (RegVal_Base (Val_Enum ((Mk_enum_id 6%nat), Mk_enum_ctor 0%nat))) (RegVal_Base (Val_Symbolic 1341%Z)) (RegVal_Base (Val_Symbolic 92%Z)) 4%N None Mk_annot :t:
