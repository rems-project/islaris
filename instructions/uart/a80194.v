...
Definition a80194 : isla_trace :=
  ...
  Smt (DefineConst 67%Z (Unop (Extract 31%N 0%N) (Val (Val_Symbolic 66%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (DefineConst 72%Z (Binop (Eq) (Val (Val_Symbolic 65%Z) Mk_annot) (Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 65%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xfffffffffffffffc%Z)) Mk_annot] Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  WriteMem (RegVal_Base (Val_Symbolic 1403%Z)) (RegVal_Poison) (RegVal_Base (Val_Symbolic 1402%Z)) (RegVal_Base (Val_Symbolic 67%Z)) 4%N None Mk_annot :t:
