...
Definition a80188 : isla_trace :=
  ...
  Smt (DefineConst 30%Z (Binop (Eq) (Manyop (Bvmanyarith Bvor) [Val (Val_Bits (BV 1%N 0x0%Z)) Mk_annot; Unop (Extract 0%N 0%N) (Binop ((Bvarith Bvlshr)) (Unop (Extract 31%N 0%N) (Val (Val_Symbolic 26%Z) Mk_annot) Mk_annot) (Val (Val_Bits (BV 32%N 0x5%Z)) Mk_annot) Mk_annot) Mk_annot] Mk_annot) (Val (Val_Bits (BV 1%N 0x0%Z)) Mk_annot) Mk_annot)) Mk_annot :t:
  tcases [
    ...
    Smt (DefineConst 32%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 31%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xfffffffffffffff8%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
