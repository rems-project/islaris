...
Definition aeb03005f : list trc := [
  [
    ...
    WriteReg "PSTATE" [Field "N"] (Val_Struct [("N", Val_Symbolic 74%Z)]) Mk_annot;
    ...
    WriteReg "PSTATE" [Field "Z"] (Val_Struct [("Z", Val_Symbolic 75%Z)]) Mk_annot;
    ...
    WriteReg "PSTATE" [Field "C"] (Val_Struct [("C", Val_Symbolic 76%Z)]) Mk_annot;
    ...
    WriteReg "PSTATE" [Field "V"] (Val_Struct [("V", Val_Symbolic 77%Z)]) Mk_annot
  ]
].
