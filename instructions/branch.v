...
(*  ReadReg "__v85_implemented" [] (Val_Bool false) Mk_annot;*)
  ...
  Smt (DefineConst 48%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 47%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x10%Z]) Mk_annot] Mk_annot)) Mk_annot;
  ReadReg "PSTATE" [Field "nRW"] (Val_Struct [("nRW", Val_Symbolic 28%Z)]) Mk_annot;
  Smt (DefineConst 49%Z (Binop (Eq) (Val (Val_Symbolic 28%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  ...
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 49%Z) Mk_annot) Mk_annot)) Mk_annot;
(*  ReadReg "__highest_el_aarch32" [] (Val_Bool false) Mk_annot;*)
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 49%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (DefineConst 52%Z (Val (Val_Symbolic 48%Z) Mk_annot)) Mk_annot;
  BranchAddress (Val_Symbolic 52%Z) Mk_annot;
  Smt (DefineConst 53%Z (Val (Val_Symbolic 48%Z) Mk_annot)) Mk_annot;
  Smt (DefineConst 54%Z (Binop (Eq) (Val (Val_Symbolic 28%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 54%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 54%Z) Mk_annot) Mk_annot)) Mk_annot;
...
(*  ReadReg "__v83_implemented" [] (Val_Bool false) Mk_annot;*)
  WriteReg "_PC" [] (Val_Symbolic 53%Z) Mk_annot;
