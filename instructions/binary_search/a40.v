...
Definition a40 : list trc := [
  [
    ...
    ReadReg "R0" [] (Val_Symbolic 53%Z) Mk_annot;
    ...
    WriteReg "PSTATE" [Field "Z"] (Val_Struct [("Z", Val_Symbolic 62%Z)]) Mk_annot;
    ...
    WriteReg "PSTATE" [Field "C"] (Val_Struct [("C", Val_Symbolic 63%Z)]) Mk_annot;
    ...
    WriteReg "PSTATE" [Field "V"] (Val_Struct [("V", Val_Symbolic 64%Z)]) Mk_annot
  ];
  [
    Smt (DeclareConst 5%Z (Ty_BitVec 1%N)) Mk_annot;
    Smt (DeclareConst 17%Z (Ty_BitVec 1%N)) Mk_annot;
