...
Definition a50 : isla_trace :=
  ...
  tcases [
    ...
    Smt (DefineConst 28%Z (Binop (Eq) (Val (Val_Symbolic 24%Z) Mk_annot) (Val (Val_Bits (BV 1%N 0x0%Z)) Mk_annot) Mk_annot)) Mk_annot :t:
    tcases [
      ...
      Smt (DefineConst 30%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 29%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xffffffffffffffdc%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
