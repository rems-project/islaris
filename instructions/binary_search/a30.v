...
Definition a30 : list trc := [
  [
    ...
    ReadReg "_PC" [] (RegVal_Base (Val_Symbolic 76%Z)) Mk_annot;
    Smt (DefineConst 77%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 76%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x4%Z]) Mk_annot] Mk_annot)) Mk_annot;
    WriteReg "_PC" [] (RegVal_Base (Val_Symbolic 77%Z)) Mk_annot
  ]
].
