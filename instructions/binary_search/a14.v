...
Definition a14 : isla_trace :=
  ...
  Smt (DefineConst 29%Z (Binop (Eq) (Binop (Eq) (Val (Val_Symbolic 26%Z) Mk_annot) (Val (Val_Bits (BV 64%N 0x0%Z)) Mk_annot) Mk_annot) (Val (Val_Bool true) Mk_annot) Mk_annot)) Mk_annot :t:
  tcases [
    ...
    Smt (DefineConst 31%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 30%Z) Mk_annot; Val (Val_Bits (BV 64%N 0x44%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
