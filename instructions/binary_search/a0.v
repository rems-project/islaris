...
Definition a0 : isla_trace :=
  ...
  Smt (DefineConst 36%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 26%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xffffffffffffffc0%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
  Smt (DeclareConst 37%Z (Ty_BitVec 64%N)) Mk_annot :t:
  ReadReg "R29" [] (RegVal_Base (Val_Symbolic 37%Z)) Mk_annot :t:
  Smt (DefineConst 38%Z (Val (Val_Symbolic 37%Z) Mk_annot)) Mk_annot :t:
  Smt (DeclareConst 39%Z (Ty_BitVec 64%N)) Mk_annot :t:
  ReadReg "R30" [] (RegVal_Base (Val_Symbolic 39%Z)) Mk_annot :t:
  ...
  Smt (DefineConst 2714%Z (Val (Val_Symbolic 36%Z) Mk_annot)) Mk_annot :t:
  WriteReg "SP_EL2" [] (RegVal_Base (Val_Symbolic 2714%Z)) Mk_annot :t:
  Smt (DeclareConst 2715%Z (Ty_BitVec 64%N)) Mk_annot :t:
  ReadReg "_PC" [] (RegVal_Base (Val_Symbolic 2715%Z)) Mk_annot :t:
  Smt (DefineConst 2716%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 2715%Z) Mk_annot; Val (Val_Bits (BV 64%N 0x4%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "_PC" [] (RegVal_Base (Val_Symbolic 2716%Z)) Mk_annot :t:
  tnil
.
