...
Definition a0 : list trc := [
  [
    ...
    Assume (AExp_Binop ((Bvcomp Bvugt)) (AExp_Val (AVal_Var "SP_EL2" []) Mk_annot) (AExp_Val (AVal_Bits [BV{64%N} 0x40%Z]) Mk_annot) Mk_annot) Mk_annot;
    Smt (Assert (Binop ((Bvcomp Bvugt)) (Val (Val_Symbolic 29%Z) Mk_annot) (Val (Val_Bits [BV{64%N} 0x40%Z]) Mk_annot) Mk_annot)) Mk_annot;
