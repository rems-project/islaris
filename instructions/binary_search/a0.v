...
Definition a0 : isla_trace :=
  ...
  Smt (Assert (Binop (Eq) (Manyop (Bvmanyarith Bvand) [Binop ((Bvarith Bvsub)) (Val (Val_Symbolic 29%Z) Mk_annot) (Val (Val_Bits [BV{64%N} 0x40%Z]) Mk_annot) Mk_annot; Val (Val_Bits [BV{64%N} 0xfff0000000000007%Z]) Mk_annot] Mk_annot) (Val (Val_Bits [BV{64%N} 0x0%Z]) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (Assert (Binop (Eq) (Manyop (Bvmanyarith Bvand) [Binop ((Bvarith Bvsub)) (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 29%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x8%Z]) Mk_annot] Mk_annot) (Val (Val_Bits [BV{64%N} 0x40%Z]) Mk_annot) Mk_annot; Val (Val_Bits [BV{64%N} 0xfff0000000000007%Z]) Mk_annot] Mk_annot) (Val (Val_Bits [BV{64%N} 0x0%Z]) Mk_annot) Mk_annot)) Mk_annot :t:
