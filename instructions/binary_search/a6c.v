...
Definition a6c : list trc := [
  [
    ...
    ReadMem (RegVal_Base (Val_Symbolic 1289%Z)) (RegVal_Base (Val_Enum ((Mk_enum_id 6%nat), Mk_enum_ctor 0%nat))) (RegVal_Base (Val_Symbolic 1288%Z)) 8%N None Mk_annot;
    ...
    ReadMem (RegVal_Base (Val_Symbolic 2478%Z)) (RegVal_Base (Val_Enum ((Mk_enum_id 6%nat), Mk_enum_ctor 0%nat))) (RegVal_Base (Val_Symbolic 2477%Z)) 8%N None Mk_annot;
    Smt (DefineConst 2481%Z (Val (Val_Symbolic 1289%Z) Mk_annot)) Mk_annot;
    WriteReg "R29" [] (RegVal_Base (Val_Symbolic 2481%Z)) Mk_annot;
    Smt (DefineConst 2482%Z (Val (Val_Symbolic 2478%Z) Mk_annot)) Mk_annot;
    WriteReg "R30" [] (RegVal_Base (Val_Symbolic 2482%Z)) Mk_annot;
    ...
    WriteReg "SP_EL2" [] (RegVal_Base (Val_Symbolic 2484%Z)) Mk_annot
  ]
].
