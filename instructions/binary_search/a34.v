...
Definition a34 : isla_trace :=
  ...
  ReadReg "R24" [] (RegVal_Base (Val_Symbolic 27%Z)) Mk_annot :t:
  ReadReg "R21" [] (RegVal_Base (Val_Symbolic 26%Z)) Mk_annot :t:
  Smt (DefineConst 70%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 26%Z) Mk_annot; Manyop Concat [Unop (Extract 60%N 0%N) (Val (Val_Symbolic 27%Z) Mk_annot) Mk_annot; Val (Val_Bits (BV 3%N 0x0%Z)) Mk_annot] Mk_annot] Mk_annot)) Mk_annot :t:
  Smt (DefineConst 74%Z (Binop (Eq) (Val (Val_Symbolic 70%Z) Mk_annot) (Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 70%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xfffffffffffffff8%Z)) Mk_annot] Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  ReadMem (RegVal_Base (Val_Symbolic 1399%Z)) (RegVal_Poison) (RegVal_Base (Val_Symbolic 1398%Z)) 8%N None Mk_annot :t:
  Smt (DefineConst 1403%Z (Val (Val_Symbolic 1399%Z) Mk_annot)) Mk_annot :t:
  WriteReg "R0" [] (RegVal_Base (Val_Symbolic 1403%Z)) Mk_annot :t:
