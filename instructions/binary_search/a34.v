...
Definition a34 : list trc := [
  [
    ...
    Smt (DeclareConst 1332%Z (Ty_BitVec 56%N)) Mk_annot;
    Smt (DefineConst 1341%Z (Unop (ZeroExtend 8%N) (Manyop Concat [Val (Val_Bits [BV{4%N} 0x0%Z]) Mk_annot; Unop (Extract 51%N 0%N) (Val (Val_Symbolic 103%Z) Mk_annot) Mk_annot] Mk_annot) Mk_annot)) Mk_annot;
