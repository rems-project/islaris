...
Definition a34 : list trc := [
  [
    ...
    ReadReg "R24" [] (Val_Symbolic 30%Z) Mk_annot;
    ReadReg "R21" [] (Val_Symbolic 29%Z) Mk_annot;
    ...
    ReadMem (Val_Symbolic 1303%Z) (Val_Enum ((Mk_enum_id 7%nat), Mk_enum_ctor 0%nat)) (Val_Symbolic 1302%Z) 8%N None Mk_annot;
    Smt (DefineConst 1307%Z (Val (Val_Symbolic 1303%Z) Mk_annot)) Mk_annot;
    WriteReg "R0" [] (Val_Symbolic 1307%Z) Mk_annot
  ]
].
