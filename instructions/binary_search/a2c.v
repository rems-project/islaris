...
Definition a2c : isla_trace :=
  ...
  ReadReg "R20" [] (RegVal_Base (Val_Symbolic 42%Z)) Mk_annot :t:
  Smt (DeclareConst 44%Z (Ty_BitVec 64%N)) Mk_annot :t:
  ReadReg "R23" [] (RegVal_Base (Val_Symbolic 44%Z)) Mk_annot :t:
  ...
  WriteReg "R8" [] (RegVal_Base (Val_Symbolic 74%Z)) Mk_annot :t:
