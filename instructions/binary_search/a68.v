...
Definition a68 : isla_trace :=
  ...
  Smt (DefineConst 36%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 26%Z) Mk_annot; Val (Val_Bits (BV 64%N 0x10%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
  ...
  WriteReg "R24" [] (RegVal_Base (Val_Symbolic 2701%Z)) Mk_annot :t:
  Smt (DefineConst 2702%Z (Val (Val_Symbolic 2698%Z) Mk_annot)) Mk_annot :t:
  WriteReg "R23" [] (RegVal_Base (Val_Symbolic 2702%Z)) Mk_annot :t:
