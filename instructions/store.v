...
(*  ReadReg "__v84_implemented" [] (Val_Bool false) Mk_annot;*)
  ReadReg "PSTATE" [Field "nRW"] (Val_Struct [("nRW", Val_Symbolic 9%Z)]) Mk_annot;
  Smt (DefineConst 94%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
...
(*  ReadReg "__highest_el_aarch32" [] (Val_Bool false) Mk_annot;*)
  ...
  Smt (DefineConst 294%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 294%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 294%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (DefineConst 297%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
...
(*  ReadReg "__v83_implemented" [] (Val_Bool false) Mk_annot;*)
  ...
  Smt (DefineConst 909%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 909%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 909%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (DefineConst 912%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 912%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 912%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (DefineConst 941%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 941%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 941%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (DefineConst 944%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 944%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 944%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (DefineConst 983%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 983%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 983%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Unop (Not) (Val (Val_Symbolic 99%Z) Mk_annot) Mk_annot) Mk_annot)) Mk_annot;
  Smt (DefineConst 1191%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 1191%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 1191%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (DefineConst 1194%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 1194%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 1194%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (DefineConst 1233%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 1233%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 1233%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (DefineConst 1236%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 1236%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 1236%Z) Mk_annot) Mk_annot)) Mk_annot;
  ReadReg "PSTATE" [Field "D"] (Val_Struct [("D", Val_Symbolic 15%Z)]) Mk_annot;
  ...
  Smt (DefineConst 1280%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 1280%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (Assert (Unop (Not) (Val (Val_Symbolic 1280%Z) Mk_annot) Mk_annot)) Mk_annot;
  Smt (DefineConst 1283%Z (Binop (Eq) (Val (Val_Symbolic 9%Z) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot;
