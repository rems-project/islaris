...
Definition a8 : isla_trace :=
  ...
  Smt (Assert (Unop (Not) (Binop (Eq) (Unop (Extract 0%N 0%N) (Binop ((Bvarith Bvlshr)) (Val (Val_Symbolic 21%Z) Mk_annot) (Unop (Extract 63%N 0%N) (Val (Val_Bits [BV{128%N} 0x0%Z]) Mk_annot) Mk_annot) Mk_annot) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Unop (Not) (Binop (Eq) (Unop (Extract 0%N 0%N) (Binop ((Bvarith Bvlshr)) (Val (Val_Symbolic 21%Z) Mk_annot) (Unop (Extract 63%N 0%N) (Val (Val_Bits [BV{128%N} 0x1%Z]) Mk_annot) Mk_annot) Mk_annot) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Unop (Not) (Binop (Eq) (Unop (Extract 0%N 0%N) (Binop ((Bvarith Bvlshr)) (Val (Val_Symbolic 21%Z) Mk_annot) (Unop (Extract 63%N 0%N) (Val (Val_Bits [BV{128%N} 0x2%Z]) Mk_annot) Mk_annot) Mk_annot) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (Assert (Binop ((Bvcomp Bvsle)) (Val (Val_Bits [BV{128%N} 0x2000000%Z]) Mk_annot) (Val (Val_Symbolic 61%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Unop (Not) (Binop ((Bvcomp Bvsle)) (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 61%Z) Mk_annot; Val (Val_Bits [BV{128%N} 0x8%Z]) Mk_annot] Mk_annot) (Val (Val_Bits [BV{128%N} 0x20c0000%Z]) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  ReadReg "rv_htif_tohost" [] (RegVal_Base (Val_Bits [BV{64%N} 0x40001000%Z])) Mk_annot :t:
  Smt (Assert (Unop (Not) (Binop (Eq) (Val (Val_Bits [BV{64%N} 0x40001000%Z]) Mk_annot) (Val (Val_Symbolic 21%Z) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Unop (Not) (Binop (Eq) (Val (Val_Bits [BV{64%N} 0x40001004%Z]) Mk_annot) (Val (Val_Symbolic 21%Z) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (Assert (Binop ((Bvcomp Bvsle)) (Val (Val_Bits [BV{128%N} 0x80000000%Z]) Mk_annot) (Val (Val_Symbolic 67%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Binop ((Bvcomp Bvsle)) (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 67%Z) Mk_annot; Val (Val_Bits [BV{128%N} 0x8%Z]) Mk_annot] Mk_annot) (Val (Val_Bits [BV{128%N} 0x84000000%Z]) Mk_annot) Mk_annot)) Mk_annot :t:
