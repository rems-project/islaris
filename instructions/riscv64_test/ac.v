...
Definition ac : isla_trace :=
  ...
  Smt (Assert (Binop (Eq) (Unop (Extract 2%N 2%N) (Val (Val_Symbolic 0%Z) Mk_annot) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (Assert (Binop (Eq) (Unop (Extract 17%N 17%N) (Val (Val_Symbolic 1%Z) Mk_annot) Mk_annot) (Val (Val_Bits [BV{1%N} 0x0%Z]) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (Assert (Binop (Eq) (Val (Val_Symbolic 6%Z) Mk_annot) (Val (Val_Enum ((Mk_enum_id 3%nat), Mk_enum_ctor 2%nat)) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (Assert (Binop (Eq) (Unop (Extract 2%N 0%N) (Val (Val_Symbolic 7%Z) Mk_annot) Mk_annot) (Val (Val_Bits [BV{3%N} 0x0%Z]) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (Assert (Binop ((Bvcomp Bvuge)) (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 7%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x8%Z]) Mk_annot] Mk_annot) (Val (Val_Bits [BV{64%N} 0x80000000%Z]) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (Assert (Binop ((Bvcomp Bvult)) (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 7%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x8%Z]) Mk_annot] Mk_annot) (Manyop (Bvmanyarith Bvadd) [Val (Val_Bits [BV{64%N} 0x80000000%Z]) Mk_annot; Val (Val_Bits [BV{64%N} 0x4000000%Z]) Mk_annot] Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (Assert (Unop (Not) (Binop (Eq) (Unop (Extract 0%N 0%N) (Binop ((Bvarith Bvlshr)) (Val (Val_Symbolic 22%Z) Mk_annot) (Unop (Extract 63%N 0%N) (Val (Val_Bits [BV{128%N} 0x0%Z]) Mk_annot) Mk_annot) Mk_annot) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Unop (Not) (Binop (Eq) (Unop (Extract 0%N 0%N) (Binop ((Bvarith Bvlshr)) (Val (Val_Symbolic 22%Z) Mk_annot) (Unop (Extract 63%N 0%N) (Val (Val_Bits [BV{128%N} 0x1%Z]) Mk_annot) Mk_annot) Mk_annot) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Unop (Not) (Binop (Eq) (Unop (Extract 0%N 0%N) (Binop ((Bvarith Bvlshr)) (Val (Val_Symbolic 22%Z) Mk_annot) (Unop (Extract 63%N 0%N) (Val (Val_Bits [BV{128%N} 0x2%Z]) Mk_annot) Mk_annot) Mk_annot) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (Assert (Unop (Not) (Binop (Eq) (Unop (Extract 17%N 17%N) (Val (Val_Symbolic 1%Z) Mk_annot) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Binop (Eq) (Val (Val_Symbolic 6%Z) Mk_annot) (Val (Val_Enum ((Mk_enum_id 3%nat), Mk_enum_ctor 2%nat)) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (DeclareConst 36%Z (Ty_BitVec 64%N)) Mk_annot :t:
  ReadReg "satp" [] (RegVal_Base (Val_Symbolic 36%Z)) Mk_annot :t:
  Smt (Assert (Unop (Not) (Binop (Eq) (Unop (Extract 17%N 17%N) (Val (Val_Symbolic 1%Z) Mk_annot) Mk_annot) (Val (Val_Bits [BV{1%N} 0x1%Z]) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  ReadReg "rv_enable_pmp" [] (RegVal_Base (Val_Bool false)) Mk_annot :t:
  ...
  Smt (Assert (Binop ((Bvcomp Bvsle)) (Val (Val_Bits [BV{128%N} 0x2000000%Z]) Mk_annot) (Val (Val_Symbolic 51%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Unop (Not) (Binop ((Bvcomp Bvsle)) (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 51%Z) Mk_annot; Val (Val_Bits [BV{128%N} 0x8%Z]) Mk_annot] Mk_annot) (Val (Val_Bits [BV{128%N} 0x20c0000%Z]) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  ReadReg "rv_htif_tohost" [] (RegVal_Base (Val_Bits [BV{64%N} 0x40001000%Z])) Mk_annot :t:
  Smt (Assert (Unop (Not) (Binop (Eq) (Val (Val_Bits [BV{64%N} 0x40001000%Z]) Mk_annot) (Val (Val_Symbolic 22%Z) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Unop (Not) (Binop (Eq) (Val (Val_Bits [BV{64%N} 0x40001004%Z]) Mk_annot) (Val (Val_Symbolic 22%Z) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (Assert (Binop ((Bvcomp Bvsle)) (Val (Val_Bits [BV{128%N} 0x80000000%Z]) Mk_annot) (Val (Val_Symbolic 57%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Binop ((Bvcomp Bvsle)) (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 57%Z) Mk_annot; Val (Val_Bits [BV{128%N} 0x8%Z]) Mk_annot] Mk_annot) (Val (Val_Bits [BV{128%N} 0x84000000%Z]) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  WriteReg "x11" [] (RegVal_Base (Val_Symbolic 73%Z)) Mk_annot :t:
