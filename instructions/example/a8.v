...
Definition a8 : isla_trace :=
  ...
  ReadReg "R28" [] (RegVal_Base (Val_Symbolic 119%Z)) Mk_annot :t:
  Smt (DefineConst 120%Z (Val (Val_Symbolic 119%Z) Mk_annot)) Mk_annot :t:
  Smt (DefineConst 125%Z (Binop (Eq) (Val (Val_Symbolic 118%Z) Mk_annot) (Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 118%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xfffffffffffffff8%Z)) Mk_annot] Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  WriteMem (RegVal_Base (Val_Symbolic 2340%Z)) (RegVal_Base (Val_Enum ((Mk_enum_id 6%nat), Mk_enum_ctor 0%nat))) (RegVal_Base (Val_Symbolic 2339%Z)) (RegVal_Base (Val_Symbolic 120%Z)) 8%N None Mk_annot :t:
