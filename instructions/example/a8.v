...
Definition a8 : list trc := [
  [
    ...
    Assume (AExp_Binop (Eq) (AExp_Manyop (Bvmanyarith Bvand) [AExp_Val (AVal_Var "R27" []) Mk_annot; AExp_Val (AVal_Bits [BV{64%N} 0xfff0000000000007%Z]) Mk_annot] Mk_annot) (AExp_Val (AVal_Bits [BV{64%N} 0x0%Z]) Mk_annot) Mk_annot) Mk_annot;
    ...
    ReadReg "R27" [] (RegVal_Base (Val_Symbolic 29%Z)) Mk_annot;
    ...
    ReadReg "R28" [] (RegVal_Base (Val_Symbolic 91%Z)) Mk_annot;
    ...
    WriteMem (RegVal_Base (Val_Symbolic 1342%Z)) (RegVal_Base (Val_Enum ((Mk_enum_id 6%nat), Mk_enum_ctor 0%nat))) (RegVal_Base (Val_Symbolic 1341%Z)) (RegVal_Base (Val_Symbolic 92%Z)) 8%N None Mk_annot;
    Smt (DeclareConst 1343%Z (Ty_BitVec 64%N)) Mk_annot;
    ReadReg "_PC" [] (RegVal_Base (Val_Symbolic 1343%Z)) Mk_annot;
    Smt (DefineConst 1344%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 1343%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x4%Z]) Mk_annot] Mk_annot)) Mk_annot;
    WriteReg "_PC" [] (RegVal_Base (Val_Symbolic 1344%Z)) Mk_annot
  ]
].
