...
Definition a14 : isla_trace :=
  ...
  ReadReg "R30" [] (RegVal_Base (Val_Symbolic 44%Z)) Mk_annot :t:
  Smt (DefineConst 45%Z (Val (Val_Symbolic 44%Z) Mk_annot)) Mk_annot :t:
  Smt (DefineConst 46%Z (Val (Val_Symbolic 45%Z) Mk_annot)) Mk_annot :t:
  BranchAddress (RegVal_Base (Val_Symbolic 46%Z)) Mk_annot :t:
  Smt (DefineConst 47%Z (Val (Val_Symbolic 45%Z) Mk_annot)) Mk_annot :t:
