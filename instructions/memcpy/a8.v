...
Definition a8 : isla_trace :=
  ...
  Assume (AExp_Binop (Eq) (AExp_Manyop (Bvmanyarith Bvand) [AExp_Manyop (Bvmanyarith Bvadd) [AExp_Val (AVal_Var "R1" []) Mk_annot; AExp_Val (AVal_Var "R3" []) Mk_annot] Mk_annot; AExp_Val (AVal_Bits (BV 64%N 0xfff0000000000000%Z)) Mk_annot] Mk_annot) (AExp_Val (AVal_Bits (BV 64%N 0x0%Z)) Mk_annot) Mk_annot) Mk_annot :t:
  ...
  Smt (DefineConst 74%Z (Binop (Eq) (Val (Val_Symbolic 70%Z) Mk_annot) (Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 70%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xffffffffffffffff%Z)) Mk_annot] Mk_annot) Mk_annot)) Mk_annot :t:
  ReadReg "PSTATE" [Field "D"] (RegVal_Struct [("D", RegVal_Base (Val_Symbolic 3%Z))]) Mk_annot :t:
  Smt (DefineConst 1249%Z (Val (Val_Symbolic 70%Z) Mk_annot)) Mk_annot :t:
  Smt (DefineConst 1397%Z (Manyop Concat [Val (Val_Bits (BV 4%N 0x0%Z)) Mk_annot; Unop (Extract 51%N 0%N) (Val (Val_Symbolic 70%Z) Mk_annot) Mk_annot] Mk_annot)) Mk_annot :t:
  Smt (DefineConst 1398%Z (Unop (ZeroExtend 8%N) (Val (Val_Symbolic 1397%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (DeclareConst 1399%Z (Ty_BitVec 8%N)) Mk_annot :t:
  ReadMem (RegVal_Base (Val_Symbolic 1399%Z)) (RegVal_Poison) (RegVal_Base (Val_Symbolic 1398%Z)) 1%N None Mk_annot :t:
  Smt (DefineConst 1403%Z (Manyop Concat [Val (Val_Bits (BV 32%N 0x0%Z)) Mk_annot; Manyop Concat [Val (Val_Bits (BV 24%N 0x0%Z)) Mk_annot; Val (Val_Symbolic 1399%Z) Mk_annot] Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "R4" [] (RegVal_Base (Val_Symbolic 1403%Z)) Mk_annot :t:
