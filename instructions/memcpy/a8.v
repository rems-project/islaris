...
Definition a8 : list trc := [
  [
    ...
    ReadMem (RegVal_Base (Val_Symbolic 1303%Z)) (RegVal_Base (Val_Enum ((Mk_enum_id 7%nat), Mk_enum_ctor 0%nat))) (RegVal_Base (Val_Symbolic 1302%Z)) 1%N None Mk_annot;
    ...
    WriteReg "R4" [] (RegVal_Base (Val_Symbolic 1307%Z)) Mk_annot
  ]
].
