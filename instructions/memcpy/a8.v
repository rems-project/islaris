...
Definition a8 : list trc := [
  [
    ...
    Assume (AExp_Binop (Eq) (AExp_Manyop (Bvmanyarith Bvand) [AExp_Manyop (Bvmanyarith Bvadd) [AExp_Val (AVal_Var "R1" []) Mk_annot; AExp_Val (AVal_Var "R3" []) Mk_annot] Mk_annot; AExp_Val (AVal_Bits [BV{64%N} 0xfff0000000000000%Z]) Mk_annot] Mk_annot) (AExp_Val (AVal_Bits [BV{64%N} 0x0%Z]) Mk_annot) Mk_annot) Mk_annot;
    ...
    Smt (DeclareConst 1342%Z (Ty_BitVec 8%N)) Mk_annot;
    ReadMem (RegVal_Base (Val_Symbolic 1342%Z)) (RegVal_Base (Val_Enum ((Mk_enum_id 7%nat), Mk_enum_ctor 0%nat))) (RegVal_Base (Val_Symbolic 1341%Z)) 1%N None Mk_annot;
    Smt (DefineConst 1346%Z (Manyop Concat [Val (Val_Bits [BV{32%N} 0x0%Z]) Mk_annot; Manyop Concat [Val (Val_Bits [BV{24%N} 0x0%Z]) Mk_annot; Val (Val_Symbolic 1342%Z) Mk_annot] Mk_annot] Mk_annot)) Mk_annot;
    WriteReg "R4" [] (RegVal_Base (Val_Symbolic 1346%Z)) Mk_annot;
