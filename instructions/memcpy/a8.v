...
Definition a8 : isla_trace :=
  ...
  Smt (DefineConst 135%Z (Binop (Eq) (Val (Val_Symbolic 131%Z) Mk_annot) (Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 131%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xffffffffffffffff%Z)) Mk_annot] Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (DeclareConst 2340%Z (Ty_BitVec 8%N)) Mk_annot :t:
  ReadMem (RegVal_Base (Val_Symbolic 2340%Z)) (RegVal_Base (Val_Enum ((Mk_enum_id 7%nat), Mk_enum_ctor 0%nat))) (RegVal_Base (Val_Symbolic 2339%Z)) 1%N None Mk_annot :t:
  Smt (DefineConst 2344%Z (Manyop Concat [Val (Val_Bits (BV 32%N 0x0%Z)) Mk_annot; Manyop Concat [Val (Val_Bits (BV 24%N 0x0%Z)) Mk_annot; Val (Val_Symbolic 2340%Z) Mk_annot] Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "R4" [] (RegVal_Base (Val_Symbolic 2344%Z)) Mk_annot :t:
