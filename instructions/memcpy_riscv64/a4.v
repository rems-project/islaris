...
Definition a4 : isla_trace :=
  ...
  Smt (Assert (Binop ((Bvcomp Bvsle)) (Val (Val_Bits [BV{128%N} 0x2000000%Z]) Mk_annot) (Val (Val_Symbolic 45%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Unop (Not) (Binop ((Bvcomp Bvsle)) (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 45%Z) Mk_annot; Val (Val_Bits [BV{128%N} 0x1%Z]) Mk_annot] Mk_annot) (Val (Val_Bits [BV{128%N} 0x20c0000%Z]) Mk_annot) Mk_annot) Mk_annot)) Mk_annot :t:
  ...
  Smt (Assert (Binop ((Bvcomp Bvsle)) (Val (Val_Bits [BV{128%N} 0x80000000%Z]) Mk_annot) (Val (Val_Symbolic 51%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  Smt (Assert (Binop ((Bvcomp Bvsle)) (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 51%Z) Mk_annot; Val (Val_Bits [BV{128%N} 0x1%Z]) Mk_annot] Mk_annot) (Val (Val_Bits [BV{128%N} 0x84000000%Z]) Mk_annot) Mk_annot)) Mk_annot :t:
