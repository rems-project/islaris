...
Definition a80004 : list trc := [
  [
    ...
    Smt (DeclareConst 216%Z (Ty_BitVec 64%N)) Mk_annot;
    ReadReg "R0" [] (RegVal_Base (Val_Symbolic 216%Z)) Mk_annot;
    Smt (DefineConst 217%Z (Val (Val_Symbolic 216%Z) Mk_annot)) Mk_annot;
    WriteReg "ELR_EL2" [] (RegVal_Base (Val_Symbolic 217%Z)) Mk_annot;
    Barrier (RegVal_Base (Val_Enum ((Mk_enum_id 2%nat), Mk_enum_ctor 27%nat))) Mk_annot;
    Smt (DeclareConst 247%Z (Ty_BitVec 64%N)) Mk_annot;
    ReadReg "_PC" [] (RegVal_Base (Val_Symbolic 247%Z)) Mk_annot;
    Smt (DefineConst 248%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 247%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x4%Z]) Mk_annot] Mk_annot)) Mk_annot;
    WriteReg "_PC" [] (RegVal_Base (Val_Symbolic 248%Z)) Mk_annot
  ]
].
