...
Definition a7404 : isla_trace :=
  ...
  Smt (DeclareConst 196%Z (Ty_BitVec 32%N)) Mk_annot :t:
  ReadReg "ESR_EL2" [] (RegVal_Base (Val_Symbolic 196%Z)) Mk_annot :t:
  Smt (DefineConst 198%Z (Manyop Concat [Val (Val_Bits (BV 32%N 0x0%Z)) Mk_annot; Val (Val_Symbolic 196%Z) Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "R0" [] (RegVal_Base (Val_Symbolic 198%Z)) Mk_annot :t:
