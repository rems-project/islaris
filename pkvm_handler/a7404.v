...
Definition a7404 : isla_trace :=
  ...
  Smt (DeclareConst 168%Z (Ty_BitVec 32%N)) Mk_annot :t:
  ReadReg "ESR_EL2" [] (RegVal_Base (Val_Symbolic 168%Z)) Mk_annot :t:
  Smt (DefineConst 170%Z (Manyop Concat [Val (Val_Bits (BV 32%N 0x0%Z)) Mk_annot; Val (Val_Symbolic 168%Z) Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "R0" [] (RegVal_Base (Val_Symbolic 170%Z)) Mk_annot :t:
