...
Definition a7404 : isla_trace :=
  ...
  Smt (DeclareConst 216%Z (Ty_BitVec 32%N)) Mk_annot :t:
  ReadReg "ESR_EL2" [] (RegVal_Base (Val_Symbolic 216%Z)) Mk_annot :t:
  Smt (DefineConst 218%Z (Manyop Concat [Val (Val_Bits [BV{32%N} 0x0%Z]) Mk_annot; Val (Val_Symbolic 216%Z) Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "R0" [] (RegVal_Base (Val_Symbolic 218%Z)) Mk_annot :t:
  Smt (DeclareConst 219%Z (Ty_BitVec 64%N)) Mk_annot :t:
  ReadReg "_PC" [] (RegVal_Base (Val_Symbolic 219%Z)) Mk_annot :t:
  Smt (DefineConst 220%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 219%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x4%Z]) Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "_PC" [] (RegVal_Base (Val_Symbolic 220%Z)) Mk_annot :t:
  tnil
.
