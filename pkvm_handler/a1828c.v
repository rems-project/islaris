...
Definition a1828c : isla_trace :=
  ...
  ReadReg "R0" [] (RegVal_Base (Val_Symbolic 46%Z)) Mk_annot :t:
  Smt (DefineConst 49%Z (Manyop (Bvmanyarith Bvor) [Manyop (Bvmanyarith Bvand) [Val (Val_Symbolic 46%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xffffffffffff0000%Z)) Mk_annot] Mk_annot; Val (Val_Bits (BV 64%N 0xca11%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "R0" [] (RegVal_Base (Val_Symbolic 49%Z)) Mk_annot :t:
