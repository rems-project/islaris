...
Definition a18228 : isla_trace :=
  ...
  Smt (DefineConst 198%Z (Unop (Extract 31%N 0%N) (Val (Val_Symbolic 196%Z) Mk_annot) Mk_annot)) Mk_annot :t:
  WriteReg "SPSR_EL2" [] (RegVal_Base (Val_Symbolic 198%Z)) Mk_annot :t:
  Barrier (RegVal_Base (Val_Enum ((Mk_enum_id 2%nat), Mk_enum_ctor 27%nat))) Mk_annot :t:
  Smt (DeclareConst 228%Z (Ty_BitVec 64%N)) Mk_annot :t:
  ReadReg "_PC" [] (RegVal_Base (Val_Symbolic 228%Z)) Mk_annot :t:
  Smt (DefineConst 229%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 228%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x4%Z]) Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "_PC" [] (RegVal_Base (Val_Symbolic 229%Z)) Mk_annot :t:
  tnil
.
