...
Definition a741c : isla_trace :=
  ...
  Smt (DefineConst 27%Z (Binop (Eq) (Val (Val_Symbolic 2%Z) Mk_annot) (Val (Val_Bits (BV 1%N 0x1%Z)) Mk_annot) Mk_annot)) Mk_annot :t:
  tcases [
    Smt (Assert (Val (Val_Symbolic 27%Z) Mk_annot)) Mk_annot :t:
    Smt (DeclareConst 28%Z (Ty_BitVec 64%N)) Mk_annot :t:
    ReadReg "_PC" [] (RegVal_Base (Val_Symbolic 28%Z)) Mk_annot :t:
    Smt (DefineConst 29%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 28%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xfffffffffffff3e4%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
    Smt (DefineConst 30%Z (Val (Val_Symbolic 29%Z) Mk_annot)) Mk_annot :t:
    BranchAddress (RegVal_Base (Val_Symbolic 30%Z)) Mk_annot :t:
    Smt (DefineConst 31%Z (Val (Val_Symbolic 29%Z) Mk_annot)) Mk_annot :t:
