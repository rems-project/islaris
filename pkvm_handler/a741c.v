...
Definition a741c : isla_trace :=
  ...
  tcases [
    ...
    Smt (DefineConst 39%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 38%Z) Mk_annot; Val (Val_Bits (BV 64%N 0xfffffffffffff3e4%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
    Smt (DefineConst 51%Z (Val (Val_Symbolic 39%Z) Mk_annot)) Mk_annot :t:
    BranchAddress (RegVal_Base (Val_Symbolic 51%Z)) Mk_annot :t:
    Smt (DefineConst 52%Z (Val (Val_Symbolic 39%Z) Mk_annot)) Mk_annot :t:
