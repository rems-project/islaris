...
Definition a1821c : isla_trace :=
  ...
  tcases [
    ...
    Smt (DefineConst 40%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 39%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x20%Z]) Mk_annot] Mk_annot)) Mk_annot :t:
