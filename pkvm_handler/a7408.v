...
Definition a7408 : list trc := [
  [
    ...
    ReadReg "R0" [] (RegVal_Base (Val_Symbolic 49%Z)) Mk_annot;
    ...
    WriteReg "R0" [] (RegVal_Base (Val_Symbolic 73%Z)) Mk_annot;
    Smt (DeclareConst 74%Z (Ty_BitVec 64%N)) Mk_annot;
    ReadReg "_PC" [] (RegVal_Base (Val_Symbolic 74%Z)) Mk_annot;
    Smt (DefineConst 75%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 74%Z) Mk_annot; Val (Val_Bits [BV{64%N} 0x4%Z]) Mk_annot] Mk_annot)) Mk_annot;
    WriteReg "_PC" [] (RegVal_Base (Val_Symbolic 75%Z)) Mk_annot
  ]
].
