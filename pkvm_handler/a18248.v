...
Definition a18248 : isla_trace :=
  ...
  WriteReg "R5" [] (RegVal_Base (Val_Bits (BV 64%N 0x4000002%Z))) Mk_annot :t:
  Smt (DeclareConst 168%Z (Ty_BitVec 64%N)) Mk_annot :t:
  ReadReg "_PC" [] (RegVal_Base (Val_Symbolic 168%Z)) Mk_annot :t:
  Smt (DefineConst 169%Z (Manyop (Bvmanyarith Bvadd) [Val (Val_Symbolic 168%Z) Mk_annot; Val (Val_Bits (BV 64%N 0x4%Z)) Mk_annot] Mk_annot)) Mk_annot :t:
  WriteReg "_PC" [] (RegVal_Base (Val_Symbolic 169%Z)) Mk_annot :t:
  tnil
.
