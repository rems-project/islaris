...
examples = [
    { "file": "examples/memcpy", "asm": 8, "isla": 5},
    { "file": "examples/memcpy_riscv64", "asm": 8, "isla": 1},
    { "file": "examples/binary_search", "instrs": "instructions/binary_search", "asm": 32, "isla": 22},
    ...
    { "file": "pkvm_handler/wp", "instrs": "pkvm_handler", "asm": 14, "isla": 11},
]
env = {
    **os.environ,
    "TIMECMD": "time -f \\t%es\\t%P",
