...
Inductive event : Set :=
 ...
 | WriteMem (valu5:valu) (wkind:valu) (addr:valu) (data:valu) (num_bytes:Z) (tag_value:valu_option) (annot5:annot) (*r write value `valu` to memory address `addr`, with write kind `wkind`, byte width `byte_width`, `tag_value` is the optional capability tag, and success flag `vvar` *)
